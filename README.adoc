...
image:https://img.shields.io/circleci/project/SmartThingsOSS/ratpack-bearer-auth.svg["Circle CI", link="https://circleci.com/gh/SmartThingsOSS/ratpack-bearer-auth/tree/master"]
